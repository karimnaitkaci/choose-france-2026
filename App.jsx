...
const DATA = [
  ...
  { name: 'Paris', lat: 48.8566, lng: 2.3522, capex: 3.1, client: 'Salesforce', sector: 'Data Center', existing: true },
  ...
  { name: 'Marseille', lat: 43.2965, lng: 5.3698, capex: 0.2, client: 'Workday', sector: 'Data Center', existing: true },
  { name: 'Angers', lat: 47.4711, lng: -0.5541, capex: 0.19, client: 'Foxconn / Bull', sector: 'Data Center', existing: true },
